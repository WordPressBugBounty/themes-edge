...
function edge_social_links() { ?>
	<div class="social-links clearfix">
		...
		if( !empty($edge_settings['edge_social_facebook']) ):
			echo '<a target="_blank" href="'.esc_url($edge_settings['edge_social_facebook']).'"><i class="fab fa-facebook"></i></a>';
		endif;
		if( !empty($edge_settings['edge_social_twitter']) ):
			echo '<a target="_blank" href="'.esc_url($edge_settings['edge_social_twitter']).'"><i class="fab fa-x-twitter"></i></a>';
		endif;
		if( !empty($edge_settings['edge_social_pinterest']) ):
			echo '<a target="_blank" href="'.esc_url($edge_settings['edge_social_pinterest']).'"><i class="fab fa-pinterest-p"></i></a>';
		endif;
		if( !empty($edge_settings['edge_social_dribbble']) ):
			echo '<a target="_blank" href="'.esc_url($edge_settings['edge_social_dribbble']).'"><i class="fab fa-dribbble"></i></a>';
		endif;
		if( !empty($edge_settings['edge_social_instagram']) ):
			echo '<a target="_blank" href="'.esc_url($edge_settings['edge_social_instagram']).'"><i class="fab fa-instagram"></i></a>';
		endif;
		if( !empty($edge_settings['edge_social_flickr']) ):
			echo '<a target="_blank" href="'.esc_url($edge_settings['edge_social_flickr']).'"><i class="fab fa-flickr"></i></a>';
		endif;
		if( !empty($edge_settings['edge_social_linkedin']) ):
			echo '<a target="_blank" href="'.esc_url($edge_settings['edge_social_linkedin']).'"><i class="fab fa-linkedin"></i></a>';
		endif;
