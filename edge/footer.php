...
<div class="site-info" <?php if($edge_settings['edge-img-upload-footer-image'] !=''){?>style="background-image:url('<?php echo esc_url($edge_settings['edge-img-upload-footer-image']); ?>');" <?php } ?>>
	...
	<?php
		...
		dynamic_sidebar( 'edge_footer_options' );
			...
			echo '<div class="copyright">';?>
					<?php  echo '&copy; ' . date_i18n(__('Y','edge')) ; ?>
	...
	<?php
		...
		if($disable_scroll == 0):?>
	<button class="go-to-top"><a title="<?php esc_attr_e('Go to Top','edge');?>" href="#masthead"><i class="fa-solid fa-angles-up"></i></a></button> <!-- end .go-to-top -->
	<?php endif; ?>
</footer> <!-- end #colophon -->
</div> <!-- end #page -->
<?php wp_footer(); ?>
